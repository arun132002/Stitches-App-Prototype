import 'package:flutter/material.dart';
  void main()=>runApp(MaterialApp(
    home:Kidsshortscustomize(),
  ));

class Kidsshortscustomize extends StatefulWidget {
   Kidsshortscustomize({Key key}) : super(key: key);

  @override
  _Kidsshortscustomize createState() => _Kidsshortscustomize();
}

class _Kidsshortscustomize extends State<Kidsshortscustomize> {
  double _currentslidervalue = 52;
  double _currentslidervalue2 =54;
  double _currentslidervalue3= 45;
